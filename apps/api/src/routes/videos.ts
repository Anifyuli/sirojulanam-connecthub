...
const controller = (req: express.Request) => new VideoController(RequestContext.getEntityManager()!);
...
router.post("/:id/tags", (req, res, next) => controller(req).addTags(req, res, next));
router.put("/:id/tags", (req, res, next) => controller(req).setTags(req, res, next));
router.delete("/:id/tags", (req, res, next) => controller(req).removeTags(req, res, next));
router.delete("/:id/tags/clear", (req, res, next) => controller(req).clearTags(req, res, next));
