...
import { requireManager } from "../middleware/authorize.ts";
...
router.get('/', authMiddleware, requireManager, (req, res, next) => controller(req).getAll(req, res, next));
...
router.get('/:id', authMiddleware, requireManager, (req, res, next) => controller(req).getById(req, res, next));
router.post('/', authMiddleware, requireManager, (req, res, next) => controller(req).create(req, res, next));
router.put('/:id', authMiddleware, requireManager, (req, res, next) => controller(req).update(req, res, next));
router.delete('/:id', authMiddleware, requireManager, (req, res, next) => controller(req).delete(req, res, next));
