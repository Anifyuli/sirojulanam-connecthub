...
export function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    if (form.newPassword && !form.currentPassword) {
      toast({ title: "Error", description: "Password lama diperlukan untuk mengubah password", variant: "destructive" });
      return;
    }
    ...
    try {
      ...
      toast({ title: "Gagal", description: err.response?.data?.error || "Gagal menyimpan", variant: "destructive" });
    } finally {
      setLoading(false);
    }
  };
